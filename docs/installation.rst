...
To install EasyMQTT, run this command in your terminal:

.. code-block:: console

    $ pip install easymqtt

This is the preferred method to install EasyMQTT, as it will always install the most recent stable release.
